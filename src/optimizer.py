...
PERSON 3: Optimizer
====================
Lower-overhead optimizer tuned for short time budgets.

Compatible with main.py importing:
...
def optimize(project, time_limit=28):
    """
    Main optimizer expected by main.py.
    ...
    # choose best initial seed, but do NOT split runtime across multiple runs
    best_order = None
    best_sched = None
    best_ms = float("inf")
...
def optimizer(project, time_limit=28):
